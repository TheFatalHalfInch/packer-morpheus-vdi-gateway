...
source "vsphere-iso" "autogenerated_1" {
  ...
  notes = "Created: ${formatdate("MMM DD YYYY hh:mm ZZZ","${timestamp()}")}"
...
build {
  ...
  provisioner "file" {
    source = "${path.root}/scripts/MorpheusVDIConfig.sh"
    destination = "/home/${var.os_user}/MorpheusVDIConfig.sh"
  }

  provisioner "shell" {
    execute_command   = "echo '${var.ssh_password}' | {{ .Vars }} sudo -E -S bash '{{ .Path }}'"
    inline = ["chmod +x /home/${var.os_user}/MorpheusVDIConfig.sh"]
  }
